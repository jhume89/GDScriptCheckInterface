class_name GDSIMethodInfo extends RefCounted
...
static func parameterless_void_method(name: String, aliases: Array[String] = []) -> GDSIMethodInfo:
...
static func setter(
	...
	return GDSIMethodInfo.void_method(
		"set_" + property_name,
		1,
		[property_class_name],
		[property_type],
